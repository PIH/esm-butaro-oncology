      ...
      <View style={styles.section}>
        ...
        <Text style={{ position: "absolute", top: 15, left: 300, width: 300 }}>
          ...
          <Text>
            ...
            {props.encounterInfo.resultsEncounter.obs.map(
              (obser) =>
                obser.concept.uuid == props.config.AccessionNumberconceptUUID &&
                obser.value
            )}
          </Text>
        </Text>
        ...
        <Text style={{ paddingBottom: 10 }}>
          ...
          <Text style={styles.textAnswers}>
            {" "}
            {props.encounterInfo.family_name} {props.encounterInfo.given_name}{" "}
            {props.encounterInfo.middle_name}
          </Text>
        </Text>
        <Text
        ...
        >
          ...
          <Text style={styles.textAnswers}>
            ...
            {props.encounterInfo.resultsEncounter.obs.map(
              (obser) =>
                obser.concept.uuid ==
                  props.config.DateBiopsySpecimenTakenconceptUUID &&
                new Date(obser.value).toLocaleString(
        ...
        <Text style={{ paddingBottom: 10 }}>
          ...
          <Text style={styles.textAnswers}>
            {" "}
            {new Date(props.encounterInfo.personBirthdate).toLocaleString(
              ["en-GB", "en-US", "en", "fr-RW"],
              { day: "numeric", month: "numeric", year: "numeric" }
            )}
          </Text>
        ...
        >
          ...
          <Text style={styles.textAnswers}>
            ...
            {props.encounterInfo.resultsEncounter.obs.map(
              (obser) =>
                obser.concept.uuid ==
                  props.config.SpecimenSubmissionDateconceptUUID &&
                new Date(obser.value).toLocaleString(
                  ["en-GB", "en-US", "en", "fr-RW"],
                  { day: "numeric", month: "numeric", year: "numeric" }
                )
        ...
        <Text style={{ paddingBottom: 10 }}>
          ...
          <Text style={styles.textAnswers}>
            ...
            {props.encounterInfo.resultsEncounter.obs.map(
              (obser) =>
                obser.concept.uuid ==
                  props.config.SendingPhysicianconceptUUID && obser.value
            )}
          </Text>
        </Text>
        <Text style={{ paddingBottom: 10 }}>
          ...
          <Text style={styles.textAnswers}>
            ...
            {props.encounterInfo.resultsEncounter.obs.map(
              (obser) =>
                obser.concept.uuid ==
                  props.config.OtherBiopsyLocationconceptUUID && obser.value
            )}
          </Text>
        </Text>
        <Text style={{ paddingBottom: 10, fontFamily: "Georgia" }}>
          Anatomical location:
        </Text>
        <Text style={{ paddingBottom: 10, paddingLeft: 10 }}>
          ...
          <Text style={styles.textAnswers}>
            ...
            {props.encounterInfo.resultsEncounter.obs.map(
              (obser) =>
                obser.concept.uuid == props.config.OrganSystemconceptUUID &&
                obser.value.name.display + ",  "
            )}
          </Text>
        </Text>
        <Text style={{ paddingBottom: 10, paddingLeft: 10 }}>
          ...
          <Text style={styles.textAnswers}>
            ...
            {props.encounterInfo.resultsEncounter.obs.map(
              (obser) =>
                obser.concept.uuid == props.config.OrganconceptUUID &&
                obser.value.name.display + ",  "
            )}
          </Text>
        </Text>
        <Text style={{ paddingBottom: 10, paddingLeft: 10 }}>
          ...
          <Text style={styles.textAnswers}>
            ...
            {props.encounterInfo.resultsEncounter.obs.map(
              (obser) =>
                obser.concept.uuid == props.config.SpecimenDetailconceptUUID &&
                obser.value
            )}
          </Text>
        </Text>
        <Text style={{ paddingBottom: 10 }}>
          ...
          <Text style={styles.textAnswers}>
            ...
            {props.encounterInfo.resultsEncounter.obs.map(
              (obser) =>
                obser.concept.uuid ==
                  props.config.OtherTestsOrProceduresconceptUUID && obser.value
            )}
          </Text>
        </Text>
        ...
        <Text style={[styles.sentenceAnswers]}>
          {props.encounterInfo.resultsEncounter.obs.map(
            (obser) =>
              obser.concept.uuid == props.config.GrossDescriptionconceptUUID &&
              obser.value
          )}
        </Text>
        ...
        <Text style={styles.sentenceAnswers}>
          {props.encounterInfo.resultsEncounter.obs.map(
            (obser) =>
              obser.concept.uuid ==
                props.config.MacroscopicExaminationconceptUUID && obser.value
          )}
        </Text>
